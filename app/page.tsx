...
import { submitOrder } from './actions'; // <--- THE UPLINK TO YOUR SERVER
      ...
      <main className="relative z-10 flex flex-col items-center flex-grow py-14 px-4">
        ...
        <div className="w-full max-w-3xl border border-purple-500/40 bg-black shadow-[0_0_60px_rgba(0,0,0,0.8)]">
          ...
          <div className="bg-purple-600 px-6 py-2.5 flex justify-between items-center">
             ...
             <span className="text-[12px] font-black text-black/70 tracking-widest uppercase italic font-bold">STATUS: READY</span>
          </div>
          ...
          <div className="p-14 flex flex-col">
            ...
            <form 
              ...
              action={async (formData) => {
                ...
                if (result.success) {
                  alert("CONFIRMED: ORDER UPLOADED TO MANIFEST.");
                } else {
            ...
            >
              <input 
                name="url" // This allows the data to be sent
                type="text" 
              ...
              <button 
                type="submit"
                className="bg-purple-600 hover:bg-purple-500 text-black font-black px-14 py-6 uppercase tracking-tighter transition-all text-sm shadow-[inset_0_0_20px_rgba(0,0,0,0.3)]"
              >
                ANALYZE
              </button>
            </form>
